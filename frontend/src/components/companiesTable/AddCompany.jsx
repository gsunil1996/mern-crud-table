...
const AddCompany = (props) => {
    ...
    const { addCompanyOpen, setAddCompanyOpen, getData, setCurrentPage } = props;
    ...
    const submitCompanyData = (e) => {
        ...
        let config = {
            method: 'POST',
            url: `http://localhost:5000/addCompany`,
            data: inputdata
        }
        //axios instance
        axios(config).then((data) => {
            ...
            setCurrentPage(1)
            // get call
            getData({ search: "", gender: "all", status: "all", sort: "new", page: 1 });
