...
const EditEmployee = (props) => {
    ...
    const { editEmployeeopen, setEditEmployeeOpen, tableRowId, getData, currentPage } = props;
    ...
    const [employeeProfileLoader, setEmployeeProfileLoader] = useState(false);
    ...
    const submitEmployeeData = (e) => {
        ...
        let config = {
            method: 'patch',
            url: `http://localhost:5000/updateEmployeeDetails/${tableRowId}`,
            data: inputdata
        }
        //axios instance
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:5000/employeesTable/${tableRowId}`)
            .then((data) => {
                // console.log(
                //     "check dataa",
                //     data.data
            ...
            .catch((error) => {
                ...
                setEmployeeProfileError("Something Went Wrong")
            })
            .finally(() => {
                setEmployeeProfileLoader(false);
            });
    }, [tableRowId, editEmployeeopen])
    ...
    return (
        <div>
            ...
            >
                ...
                {employeeProfileLoader || inputdata?.fname?.length == undefined || inputdata?.fname?.length == 0 ? (
                    <div style={{ width: "100%", marginTop: "20px" }}>
                        <LinearProgress />
                    </div>
                ) : employeeProfileError.length > 0 ? (
